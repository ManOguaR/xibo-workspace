import { XiboPropertyGroup, XiboPropertyDefinition, registerProperty } from "../build/properties-build.js";

export function XiboProperty(definition: XiboPropertyDefinition) {
    return registerProperty("properties", definition);
}

export function XiboSetting(definition: XiboPropertyDefinition) {
...
// export function XiboProperty(definition: XiboPropertyDefinition) {
//     return register("properties", definition);
// }

// export function XiboSetting(definition: XiboPropertyDefinition) {
//     return register("settings", definition);
// }
